-- Pending bookings are also active reservations and must prevent overlap.

drop index if exists public.appointments_confirmed_barber_date_time_idx;

create index if not exists appointments_open_barber_date_time_idx
...
begin
  ...
  if found then
    raise exception using
      ...
      detail = 'Somente atendimentos pendentes ou confirmados ocupam a agenda; cancelados e concluidos liberam o horario.';
  end if;
