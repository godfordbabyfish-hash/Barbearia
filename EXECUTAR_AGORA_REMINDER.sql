...
-- IMPORTANTE: Substitua 'YOUR_SERVICE_ROLE_KEY' na linha 28 pela sua chave real!
...
-- ⚠️ SUBSTITUA 'YOUR_SERVICE_ROLE_KEY' pela sua chave real na linha abaixo!
...
-- ============================================
-- PRONTO! O cron job está configurado.
-- ============================================
