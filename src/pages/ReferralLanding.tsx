...
export default function ReferralLanding(){
  ...
  useEffect(()=>{ if(!code)return; localStorage.setItem('pending_referral_code',code); (supabase as any).rpc('get_referrer_display_name',{p_code:code}).then(({data}:any)=>setReferrer(data||'')); },[code]);
