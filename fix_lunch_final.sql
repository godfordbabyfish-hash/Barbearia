-- Versão final simplificada - sem funções complexas
-- Execute este script para corrigir o problema de almoço

-- 1. Adicionar almoço aos barbeiros que não têm
...
-- 4. Agendamentos durante almoço (sem STRING_AGG)
SELECT 'AGENDAMENTOS PROBLEMATICOS (28/02)' as status,
       appointment_time,
       client_name,
       barber_id
FROM appointments 
...
-- 5. Teste final - deve mostrar BLOQUEADO para ambos
